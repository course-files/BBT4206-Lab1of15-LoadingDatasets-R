...
#
# Lecturer: Allan Omondi <aomondi@strathmore.edu>
# *********************************************************************************
...
### Sources ----
##### [Primary] Source 1: https://archive.ics.uci.edu/ml/datasets/Dow+Jones+Index ----
##### [Secondary] Source 2:  https://code.datasciencedojo.com/datasciencedojo/datasets/tree/master/Dow%20Jones%20Index ====
##### [Secondary] Source 3: https://www.kaggle.com/datasets/mnassrib/dow-jones-industrial-average ----
...
# The presence of the dollar sign can make a tool like R assume that the variable stores a text field, yet it is supposed to store an integer.
...
### Sources ----
#### [Primary] Source 1:  https://archive.ics.uci.edu/ml/datasets/default+of+credit+card+clients ====
#### [Secondary] Source 2: https://code.datasciencedojo.com/datasciencedojo/datasets/tree/master/Default%20of%20Credit%20Card%20Clients ====
### Code ====
library(readr)
defaulter_dataset <-
  readr::read_csv(
...
## Sources ----
#### [Primary] Source 1: https://archive.ics.uci.edu/ml/datasets/Daily+Demand+Forecasting+Orders ----
#### [Secondary] Source 2: https://code.datasciencedojo.com/datasciencedojo/datasets/tree/master/Daily%20Demand%20Forecasting%20Orders ----
### Code ----
library(readr)
...
### [Primary] Source 1: https://archive-beta.ics.uci.edu/dataset/592/iranian+churn+dataset ----
### Code ----
library(readr)
...
# References ----
# Refer to the APA 7th edition manual here for rules on citing datasets: https://apastyle.apa.org/style-grammar-guidelines/references/examples/data-set-references

## Brown, M. (2014). Dow Jones index (Version 1) [Dataset]. University of California, Irvine (UCI) Machine Learning Repository. https://doi.org/10.24432/C5788V ----

## Ferreira, R., Martiniano, A., Ferreira, A., Ferreira, A., & Sassi, R. (2017). Daily demand forecasting orders (Version 1) [Dataset]. University of California, Irvine (UCI) Machine Learning Repository. https://doi.org/10.24432/C5BC8T ----

## Iranian churn dataset (Version 1). (2020). [Dataset]. University of California, Irvine (UCI) Machine Learning Repository. https://doi.org/10.24432/C5JW3Z ----
